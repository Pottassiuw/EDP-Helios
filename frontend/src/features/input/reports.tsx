...
import type { Celula, InputDataset, NotaInput, Status10Registro } from './types';
...
function calcularSLA(n: NotaInput): SLADados {
  ...
  if (isPending) {
    ...
    return { nota: n, statusSLA: 'Pendente No Prazo', desvio: 1, textoDesvio: 'Pendente (+1m tolerância)' };
  } else {
    if (desvio < 0) {
